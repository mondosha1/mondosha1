module.exports = {
  ...
  rules: {
      ...
      'error',
      {
        paths: [
          '@progress/kendo-angular-dialog',
          {
            name: 'rxjs/operators',
            importNames: ['tap'],
            message: 'Prefer use tap from @elium/shared/util'
          },
          {
            name: 'lodash/fp',
    ...
    '@nrwl/nx/enforce-module-boundaries': [
      'error',
      {
        allow: ['@angular/core/testing', '@elium/shared/data-core/mocks', '@elium/shared/util/testing'],
        depConstraints: [
          {
          ...
          {
            sourceTag: 'scope:site-elium',
            onlyDependOnLibsWithTags: ['scope:site-elium', 'scope:website', 'scope:shared']
          },
          {
